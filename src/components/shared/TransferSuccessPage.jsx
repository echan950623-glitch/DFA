...
/**
 * Shared layout for a school's transfer success story page.
 * Props:
 *   heroTitle, heroSubtitle   — top ProgramHero content
 *   stories                   — array of { name, college, university, major, gpa, story }
 *   ctaHeading                — bottom banner heading, e.g. "你也能成為下一個 UCLA 學生"
 */
export default function TransferSuccessPage({ heroTitle, heroSubtitle, stories, ctaHeading }) {
  return (
    <>
      <ProgramHero title={heroTitle} subtitle={heroSubtitle} />
      ...
      <section className="bg-dfa-gradient section-padding">
        <div className="container-max text-center">
          <ScrollReveal>
            <h2 className="text-3xl font-black text-white mb-6">{ctaHeading}</h2>
            <a
